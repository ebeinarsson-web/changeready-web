export const theme = {
  ...
  navLink:
    "rounded-full px-3 py-2 text-sm font-medium text-muted transition-colors hover:bg-surface-muted/85 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
  panel:
  ...
  bodySm: "text-[0.95rem] leading-6 text-muted",
  primaryButton:
  ...
  secondaryButton:
    "inline-flex items-center justify-center rounded-full border border-border bg-surface-muted/90 px-5 py-3 text-sm font-medium text-foreground transition-colors hover:border-border-strong hover:bg-surface-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  ghostButton:
    "inline-flex items-center justify-center rounded-full px-3 py-2 text-sm font-medium text-muted transition-colors hover:bg-surface-muted/60 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
} as const;
